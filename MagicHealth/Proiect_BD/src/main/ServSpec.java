...
public class ServSpec extends JFrame implements ActionListener {
    ...
    public ServSpec(String user, String role, Connection connection, Integer id_serviciu) {
        this.uid = user;
        this.role = role;
        this.con = connection;

        setTitle("Adaugare specializare serviciu medical");
        ...
        salvareButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (numeM.isEmpty() || prenumeM.isEmpty() || durata.isEmpty() || pret.isEmpty()) {
                        ...
                        ResultSet found = stmt2.executeQuery(findDoctor);
                        found.next();

                        String statement = "CALL adaugare_serviciu_specializat(?, ?, ?, ?);";
                        CallableStatement stmt = con.prepareCall(statement);
                        stmt.setInt(1, id_serviciu);
                        stmt.setInt(2, found.getInt("cnp"));
                        stmt.setString(3, durata);
                        stmt.setFloat(4, Float.parseFloat(pret));
