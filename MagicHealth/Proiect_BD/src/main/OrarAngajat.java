...
public class OrarAngajat extends JFrame implements ActionListener {
    ...
    public OrarAngajat(String user, String role, Connection connection, String nume, String prenume, String functie) {
        this.uid = user;
        this.role = role;
        this.con = connection;

        setTitle("Vizualizare orar angajat");
        ...
        try {
            ...
            text.setText("Orarul angajatului " + nume + " " + prenume + ":");
