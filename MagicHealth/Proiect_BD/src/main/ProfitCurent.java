...
public class ProfitCurent extends JFrame implements ActionListener {
    ...
    public ProfitCurent(String user, String role, Connection connection) {
        this.uid = user;
        this.role = role;
        this.con = connection;

        setTitle("Vizualizare profit curent");
        ...
        label.setText("Profit curent pentru luna " + LocalDate.now().getMonthValue() + ", anul " + LocalDate.now().getYear() + ":");

        try {
            String statement = "CALL profit_curent_lunar(?, ?);";
